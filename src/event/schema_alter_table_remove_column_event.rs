...
pub struct SchemaAlterTableRemoveColumnEvent<'table, 'column: 'table> {
...
impl Event for SchemaAlterTableRemoveColumnEvent<'_, '_> {
    fn is_async() -> bool {
        false
    }
...
impl<'table, 'column: 'table> SchemaAlterTableRemoveColumnEvent<'table, 'column> {
    pub(crate) fn new(
        column: &'column Column,
