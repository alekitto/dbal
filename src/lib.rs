...
///! meaning that changing a simple environment is sufficient to switch the
///! whole DB driver.
///!
///! # Connection examples
///!
...
///! [`DatabasePlatform`](./platform/mod.rs) and [`SchemaManager`](./schema/schema_manager.rs)
...
///! See [`EventManager`] for further information.
